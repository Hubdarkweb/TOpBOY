      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> © 𝐂ʀᴇᴀᴛᴇᴅ 𝐁ʏ 𝐂yberpunk🌊🥷🗽🐼' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> © 𝐂ʀᴇᴀᴛᴇᴅ 𝐁ʏ 𝐂yberpunk🌊🥷🗽🐼' };
          }
